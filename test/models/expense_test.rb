...
class ExpenseTest < ActiveSupport::TestCase
  ...
  test "expense missing date of expense should be invalid" do
    expense_missing_expense_date = Expense.new(where: "Lidl", comment: "", expense_date: nil, expenses_in_euro: 23.0)
    assert_not expense_missing_expense_date.valid?
  end

  test "malformatted date of expense should be invalid" do
    expense_expense_date_false_format = Expense.new(where: "Lidl", comment: "", expense_date: "yesterday", expenses_in_euro: 23.0)
    assert_not expense_expense_date_false_format.valid?
  end
