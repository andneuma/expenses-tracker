...
class ExpensesControllerTest < ActionController::TestCase
  ...
  test "should update valid changes to given expense" do
    put :update, expense_list_id: @expense_list.id, id: @expense.id, expense: {where: "Aldi", expense_date: "1954-04-23", expenses_in_euro: 23, comment: "adasdasd"}
  ...
  test "should not update invalid changes to given expense" do
    put :update, expense_list_id: @expense_list.id, id: @expense.id, expense: {expense_date: "1954-04-23", expenses_in_euro: 238, comment: "adasdasd"}
    @expense.reload.where
  ...
  test "should add valid new expense" do
    assert_difference 'Expense.count' do
      post :create, expense_list_id: @expense_list.id, expense: {where: "Aldi", expense_date: "1954-04-23", expenses_in_euro: 23, comment: "adasdasd"}
    end
    assert_redirected_to expense_list_path(@expense_list)
  end
