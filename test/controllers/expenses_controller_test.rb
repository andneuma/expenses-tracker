...
class ExpensesControllerTest < ActionController::TestCase
  ...
  test 'should update valid changes to given expense' do
    put :update, expense_list_id: @expense_list.id, id: @expense.id, expense:
      {
        where: 'Aldi',
        expense_date: '1954-04-23',
        expenses_in_euro: 23,
        comment: 'adasdasd'
      }
  ...
  test 'should add valid new expense' do
    assert_difference 'Expense.count' do
      post :create, expense_list_id: @expense_list.id, expense:
      {
        where: 'Aldi',
        expense_date: '1954-04-23',
        expenses_in_euro: 23,
